...
public static class Colors
{
    ...
    public static (uint DefaultColor, string Name, string Description) Data(this ColorId color)
        => color switch
        {
            ...
            ColorId.ModdedItemMarker           => (0xFFFF20FF, "已修改物品标记",         "在解锁总览选项卡中表示该物品在当前选择的Penumbra合集中的颜色。"                  ),
            ColorId.ContainsItemsEnabled       => (0xFFA0F0A0, "启用的模组包含设计物品", "在关联模组下拉菜单中启用的模组包含此设计中使用的物品时的颜色。"                  ),
            ColorId.ContainsItemsDisabled      => (0x80A0F0A0, "禁用的模组包含设计物品", "在关联模组下拉菜单中禁用的模组包含此设计中使用的物品时的颜色。"                  ),
            ColorId.AdvancedDyeActive          => (0xFF58DDFF, "高级染料激活",           "如果此槽位有任何高级染料激活，高级染料按钮和标记的高亮颜色。"                    ),
