...
public sealed class UnlockTable : TableBase<UnlockCacheItem, UnlockTable.Cache>, IUiService
{
    ...
    private void DrawScrollCombo(in Cache cache)
    {
        ...
        if (!_currentItem.Item.Valid)
            Im.Tooltip.Set("在此处按住 Ctrl 并滚动鼠标滚轮，即可按顺序将列表中的可见项目应用到角色身上。"u8);
    ...
    private sealed class ModdedColumn : FlagColumn<UnlockCacheItem.Modded, UnlockCacheItem>
    {
        ...
        protected override IReadOnlyList<(UnlockCacheItem.Modded Value, StringU8 Name)> EnumData
            =>
            [
                (UnlockCacheItem.Modded.Relevant, new StringU8("任何相关模组"u8)),
                (UnlockCacheItem.Modded.Ignored, new StringU8("仅忽略模组"u8)),
                (UnlockCacheItem.Modded.None, new StringU8("未模组化"u8)),
            ];
    ...
    private sealed class SlotColumn : FlagColumn<EquipFlag, UnlockCacheItem>
    {
        ...
        [
            ...
            (EquipFlag.Ears, new StringU8("耳部"u8)),
            (EquipFlag.Neck, new StringU8("颈部"u8)),
            (EquipFlag.Wrist, new StringU8("腕部"u8)),
            (EquipFlag.RFinger, new StringU8("戒指"u8)),
            (EquipFlag.Mainhand, new StringU8("主手武器"u8)),
            (EquipFlag.Offhand, new StringU8("副手武器"u8)),
        ];
